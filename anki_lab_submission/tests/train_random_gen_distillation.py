...
def train_mp(teacher,student,student_name, metadata, test_folder, device, train_loader,valid_loader):
        
        clear_output(wait=True)
        metadata["experiment_name"]=f"{test_folder}/{student_name}"
        trainer=TrainerDistillation(teacher, student, device, train_loader, valid_loader,metadata) 
        trainer.train()
